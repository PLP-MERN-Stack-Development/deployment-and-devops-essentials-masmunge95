...
export default defineConfig(({ mode, command }) => {
  ...
  // Extract Sentry's domain from the DSN for the CSP
  const sentryDsn = env.VITE_SENTRY_DSN_CLIENT || '';
  const sentryIngestDomain = sentryDsn ? new URL(sentryDsn).hostname : '';
            ...
            server.middlewares.use((_req, res, next) => {
              ...
              res.setHeader(
                ...
                [
                  ...
                  `connect-src 'self' ${apiOrigin} https://${clerkFrontendApi} wss://${clerkFrontendApi} https://clerk-telemetry.com https://*.google.com https://challenges.cloudflare.com https://*.cloudflare.com https://${sentryIngestDomain}`,
